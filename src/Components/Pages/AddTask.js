                                                         ...
                                                         <Form.Group>
                                                             ...
                                                             <Form.Control as='select' onChange={(e)=>{
                                                                 if(e.target.value != 0){
                                                                    ...
                                                                    setsubgoalliststate(subgoalliststate.filter((sg)=>{return  sg.Goal_ID == e.target.value}));
                                                                    setshowTasks(false);
                                                                    setshowButton(false);
                                                                ...
                                                                <Form.Group>
                                                                    ...
                                                                    <Form.Control as='select' onChange={(e)=>{
                                                                        if(e.target.value != 0){
                                                                            ...
                                                                            settaskliststate(taskliststate.filter((t)=>{return  t.SubGoal_ID == e.target.value}));
                                                                            setshowButton(false);
                                                                            setshowTasks(true);
                                                                        }else{
                                                                            setshowButton(false);
